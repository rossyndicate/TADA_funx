...
test_it_once <- TADA_GetATTAINS(data = TADA_dataset_1, export = TRUE)
...
another_test <- TADA_GetATTAINS(data = TADA_MakeSpatial(TADA_selection_1), export = FALSE)

# Test that TADA_GetATTAINS() works on non-spatial WQP data:
and_another_test <- TADA_GetATTAINS(data = TADA_dataset_1, export = FALSE) 

# Test that TADA_GetATTAINS()'s export of ATTAINS geospatial data works (i.e., export = TRUE):
last_test <- TADA_GetATTAINS(data = TADA_dataset_1, export = TRUE) 
```
